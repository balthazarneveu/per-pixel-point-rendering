...
from pixr.synthesis.interactive_projections import set_camera_parameters, generate_3d_scene
...
def main():
    ...
    nice_config = {'yaw_deg': 8.861538461538487, 'pitch_deg': 10.523076923076928, 'roll_deg': -
    ...
    proj_point_cloud_gt = forward_chain(yaw_gt, pitch_gt, roll_gt, cam_pos_gt)
    ...
    with torch.autograd.set_detect_anomaly(True):
        ...
        for step in range(4000):
            optimizer.zero_grad()
            proj_point_cloud = forward_chain(yaw, pitch, roll, cam_pos)
